...
INSERT INTO "outfunds__Funding_Program__c" VALUES(3,'Education','','','','In progress','True','','');
INSERT INTO "outfunds__Funding_Program__c" VALUES(4,'Community Impact','','','','In progress','True','','');
...
INSERT INTO "outfunds__Funding_Program__c" VALUES(6,'Strategic Nonprofit Development','','','','Planned','True','','');
CREATE TABLE "outfunds__Funding_Request_Role__c" (
	id INTEGER NOT NULL, 
	"outfunds__Role__c" VARCHAR(255), 
	"outfunds__Status__c" VARCHAR(255), 
	outfunds__contact__c VARCHAR(255), 
	outfunds__funding_request__c VARCHAR(255), 
	PRIMARY KEY (id)
);
...
CREATE TABLE "outfunds__Funding_Request__c" (
	...
	applying_contact_id VARCHAR(255), 
	applying_organization_id VARCHAR(255), 
